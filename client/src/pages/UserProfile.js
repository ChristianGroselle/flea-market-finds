...
import { QUERY_BOOTH, QUERY_USER } from "../utils/queries";
            ...
            {user ? (
                <>
                    ...
                    <ul>
                        ...
                        <li>Orders PurchasedAt (Work in Progress): {user.orders[0].purchaseDate}</li>
                        <li>Orders Products (Work in Progress): {user.orders[0].products[0].name}</li>
                        {/* <li>
                        {
                            user.orders[0].map((product) => (
                            <p key={user.orders._id}>
                                {product.name} - {product.price}
                            </p>
                            ))
                        }
